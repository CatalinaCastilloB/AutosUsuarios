...
<div class = container>
    ...
    <form:form action="/ingresoAutomovil/Auto/actualizar/${auto.id}" method="post" modelAttribute="auto">
        ...
        <br>
        <br>
        <input type="submit" class="btn btn-outline-primary" value ="Actualizar Auto">
